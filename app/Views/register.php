        ...
        <div class="row">
            <div class="col-md-2 sidebar d-flex flex-column bg-light" style="height: 100vh;">
                ...
                <div class="mt-2 mb-5" bis_skin_checked="1">
                    <a href="/Register" class="d-flex align-items-center link-dark text-decoration-none" aria-expanded="false">
                ...
                <div class="login-form d-flex justify-content-center align-items-center">
                    <form action="/saveUser" method="POST">
                        ...
                        <div class="text-center">
                            <p>Already Have an account?<a href="/"> Login here <br></a><p>
                            <button type="submit" class="sbmitbtn btn btn-secondary">Register</button>
                        </div>
                    </form>
                </div>
            </div>
